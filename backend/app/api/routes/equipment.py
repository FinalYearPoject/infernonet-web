...
def list_equipment(
    ...
    return {"equipment": svc.list_equipment(organization_id=organization_id, status=status, incident_id=incident_id, limit=limit)}


@router.get("/equipment/{equipment_id}", summary="Get equipment by ID")
...
@router.post("/equipment", status_code=status.HTTP_201_CREATED, summary="Create equipment")
...
@router.patch("/equipment/{equipment_id}", summary="Update equipment (status, location, incident)")
